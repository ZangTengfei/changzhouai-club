...
> 状态：M2 开发中｜更新日期：2026-07-18｜当前版本：`0.2.0`
...
- 首页、资讯、活动、我的四个 Tab，以及活动详情、资料编辑、成长进度、设置等页面。
...
> 实施进度：已在 `0.2.0` 体验版完成数据库迁移、接口验收与真机验证。
...
> 实施进度：开发中。已实现小程序内容 API、资讯 Tab、当前热点、详情收藏/分享记录，以及群聊日报自动同步与隐藏开关；待完成体验版发布和真机验收。
...
- 新增“资讯”Tab，包含“精选”“AI 快讯”“群聊精华”，并在精选顶部展示多源聚合的当前热点。
...
- 网站已展示的群聊日报默认将脱敏摘要同步到小程序，后台可对个别敏感日报单独隐藏。
