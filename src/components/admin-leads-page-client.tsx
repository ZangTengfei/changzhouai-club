  ...
  return (
    <div className="admin-page-stack">
      <section className="surface admin-card">
        <div className="admin-toolbar">
          ...
          <div className="admin-toolbar-side">
            ...
            <div className="admin-mini-stat">
              <strong>{data?.stats.newCount ?? "..."}</strong>
              <span>新线索</span>
            </div>
            <div className="admin-mini-stat">
              <strong>{data?.stats.contactedCount ?? "..."}</strong>
              <span>已联系</span>
            </div>
            <div className="admin-mini-stat">
              <strong>{data?.stats.qualifiedCount ?? "..."}</strong>
              <span>可跟进</span>
            </div>
            <div className="admin-mini-stat">
              <strong>{data?.stats.matchedCount ?? "..."}</strong>
              <span>已匹配成员</span>
            </div>
          </div>
        </div>
      ...
      <section className="surface admin-card">
        ...
        {isLoading ? (
          <div className="note-strip">正在加载合作线索...</div>
