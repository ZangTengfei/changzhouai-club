  ...
  return (
    <div className="grid gap-7 max-sm:gap-[22px]" data-events-page>
      ...
      {scheduledEvents.length > 0 ? (
        <section className="grid gap-5 pt-3 [&>.home-kicker]:bg-[#edf5ff] [&_.card-grid]:grid-cols-[repeat(auto-fit,minmax(min(100%,300px),420px))] [&_.card-grid]:items-stretch [&_.card-grid]:justify-start" id="upcoming">
