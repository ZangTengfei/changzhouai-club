...
export function AdminWeDailyReportsClient({
  ...
  async function exportImage() {
    ...
    try {
      const response = await fetch(`/api/admin/wedaily/reports/${selectedReport.id}/export-template`, {
        cache: "no-store",
      });
      ...
      await downloadWeDailyReportTemplatePng(payload, `changzhou-group-daily-${selectedReport.date}.png`);
      ...
      <section className="grid min-w-0 gap-3">
        ...
        {selectedReport ? (
          <>
            ...
            <Textarea
              className="min-h-[62vh] resize-y font-mono text-[13px] leading-6"
              value={markdown}
